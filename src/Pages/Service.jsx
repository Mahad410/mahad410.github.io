        ...
        <div className="pr_container">
            ...
            <div className="ser_container">
                ...
                <div className="sale_text">
                    <h3><span className="co">&lt;</span> Code your new <span className='co'>Website</span> <span
                        className="co">/&gt;</span></h3>
                    <p>
            ...
            <div className="ser_container">
                ...
                <div className="sale_text">
                    <h3><span className="co">&lt;</span> Code your new website on <span className='co'>Wordpress</span>
                        <span className="co">/&gt;</span></h3>
                    <p>
            ...
            <div className="ser_container">
                ...
                <div className="sale_text">
                    <h3><span className="co">&lt;</span> Make your site <span className='co'>Responsive</span> <span
                        className="co">/&gt;</span></h3>
                    <p>
            ...
            <div className="ser_container">
                ...
                <div className="sale_text">
                    <h3><span className="co">&lt;</span> Need a <span className='co'>Mentor</span> ? <span
                        className="co">/&gt;</span></h3>
                    <p>
