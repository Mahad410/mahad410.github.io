...
<div className="p_container">
                <div className="image">
                    <a href={cyber} ><img src={cyber} width="100%" height="200px" alt="cybersec"></img></a>
                </div>
        ...
        <div className="p_container">
                <div className="image">
                    <a href={entre} ><img src={entre} width="100%" height="200px" alt="entrepreneur"></img></a>
                </div>
                <div className="detail">
        ...
        <div className="p_container">
                <div className="image">
                    <a href={network} ><img src={network} width="100%" height="200px" alt="networking"></img></a>
                </div>
                <div className="detail">
        ...
        <div className="p_container">
                <div className="image">
                    <a href={iot} ><img src={iot} width="100%" height="200px" alt="iot"></img></a>
                </div>
                <div className="detail">
        ...
        <div className="p_container">
                <div className="image">
                    <a href={linux} ><img src={linux} width="100%" height="200px" alt="appreciation"></img></a>
                </div> 
                <div className="detail">
