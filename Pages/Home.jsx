...
function Home(){
    return(
        ...
        Developer with skills of <span className="co">HTML</span> | <span className="co">CSS</span> | <span className="co">SASS</span> | <span className="co">Bootstrap</span> | <span className="co">JQuery</span> | <span className="co">JavaScript</span> | <span className="co">WordPress</span> | <span className="co">React Js</span> |
            <span className="co"> Python</span> | <span className="co">Data Manipulation</span> | <span className="co">SQL</span> and many <span className="co">more....</span>
        </p> 
        <p className="desc">
             <span className="co">Passionate</span> and <span className="co">Inspiring</span> developer who is building his <span className="co">Empire</span> and will do everything to achieve his <span className="co">Dreams</span>.
